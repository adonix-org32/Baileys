...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (((0, WABinary_1.isJidGroup)(jid) || (0, WABinary_1.isJidUser)(jid)) && (content.buttons || content.templateButtons || content.listMessage)) {
                const bizNode = {
                    tag: 'biz',
                    attrs: {},
                    content: getInteractiveMessageNode(content)
                };
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' && 'album' in content && content.album) {
                ...
                const delayMs = Math.random() * config.messageSendDelay * 2;
...
const getInteractiveMessageNode = (content) => {
    const interactiveContent = (0, Utils_1.getInteractiveMessageContent)(content);
    ...
    const node = {
        ...
        content: [
            {
                tag: interactiveContent.type,
                attrs: interactiveContent.attrs,
